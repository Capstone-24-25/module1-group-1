...
Finally, we used a combination of selecting more proteins and a fuzzy intersection. We selected the top 20 predictive proteins from each of the methods and chose the proteins common to all 3 methods. Then we removed any proteins that were not in the top 10 for their respective method.
